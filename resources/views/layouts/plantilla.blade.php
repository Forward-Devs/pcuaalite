...
<html lang="{{ app()->getLocale() }}" >
    ...
    <!--Fin::Estilos de base -->
		...
		<style media="screen">
		.m-header .m-header__top { background: #271D3B; }
		.m-brand { background: #271D3B; }
		.m-header .m-header__bottom { background: #1F172E; }
							...
							<div class="m-stack__item m-stack__item--middle m-stack__item--fluid">
								<div id="m_header_menu" class="m-header-menu m-aside-header-menu-mobile m-aside-header-menu-mobile--offcanvas  m-header-menu--skin-dark m-header-menu--submenu-skin-light m-aside-header-menu-mobile--skin-dark m-aside-header-menu-mobile--submenu-skin-dark "  >
									<ul class="m-menu__nav  m-menu__nav--submenu-arrow ">
										...
										<li class="m-menu__item @if(Route::currentRouteName() == 'shouts') m-menu__item--active @endif"  aria-haspopup="true">
											<a  href="{{url('/shouts')}}" class="m-menu__link ">
												<span class="m-menu__item-here"></span>
												<span class="m-menu__link-text">
													Shouts
												</span>
										...
										<li class="m-menu__item "  aria-haspopup="true">
											<a  href="https://www.onyx-games.com/foro/" class="m-menu__link ">
												<span class="m-menu__item-here"></span>
												<span class="m-menu__link-text">
													Foro
												</span>
