...
<html lang="{{ app()->getLocale() }}" >
	...
	<body class="m-page--wide m-header--fixed m--skin-dark m-header--fixed-mobile m-footer--push m-aside--offcanvas-default"  >
		<div id="app">
								...
								<div class="m-stack__item m-stack__item--middle m-stack__item--fluid">
									<div id="m_header_menu" class="m-header-menu m-aside-header-menu-mobile m-aside-header-menu-mobile--offcanvas  m-header-menu--skin-dark m-header-menu--submenu-skin-light m-aside-header-menu-mobile--skin-dark m-aside-header-menu-mobile--submenu-skin-dark "  >
										<ul class="m-menu__nav  m-menu__nav--submenu-arrow ">
											<li @click="menu=0" class="m-menu__item" v-bind:class="{ 'm-menu__item--active': (menu === 0) }" aria-haspopup="true">
											...
											<li @click="menu=1" class="m-menu__item" v-bind:class="{ 'm-menu__item--active': (menu === 1) }" aria-haspopup="true">
												<a  href="#" class="m-menu__link ">
													<span class="m-menu__item-here"></span>
													<span class="m-menu__link-text">
														Shouts
											...
											<li @click="menu=2" class="m-menu__item" v-bind:class="{ 'm-menu__item--active': (menu === 2) }" aria-haspopup="true">
												<a  href="#" class="m-menu__link ">
													<span class="m-menu__item-here"></span>
													<span class="m-menu__link-text">
														{{__('web.noticias')}}
								...
								<div class="m-stack__item m-stack__item--right m-stack__item--middle m-stack__item--first">
									<ul class="m-footer__nav m-nav m-nav--inline m--pull-right">
										...
										<li class="m-nav__item m-nav__item--last">
											<a href="{{url('faq')}}" class="m-nav__link" data-toggle="m-tooltip" title="FAQ" data-placement="left">
