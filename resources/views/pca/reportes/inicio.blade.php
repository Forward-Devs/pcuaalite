...
@section('content')
  @php
    $modelo = Reporte::orderBy('id', 'desc')->get();
        ...
        <tbody>
          @foreach ($modelo as $mod)
            <tr>
              ...
              <td>
                <a href="{{route('reporte.show', ['id' => $mod->id])}}" class="btn btn-success m-btn m-btn--icon m-btn--icon-only"><i class="flaticon-edit-1"></i></a>
              </td>
