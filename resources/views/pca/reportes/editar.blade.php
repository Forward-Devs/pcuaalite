    ...
    <div class="m-portlet__head">
      <div class="m-portlet__head-caption">
        <div class="m-portlet__head-title">
          <h3 class="m-portlet__head-text">Editar Reporte</h3>
        </div>
      </div>
    </div>
    <form class="m-form m-form--fit m-form--label-align-right" action="{{route('reportes.update', ['id' => $modelo->id])}}"  method="post">
      {{ csrf_field() }}
      {{ method_field('PUT') }}
