    ...
    <div class="m-portlet__head">
      <div class="m-portlet__head-caption">
        <div class="m-portlet__head-title">
          <h3 class="m-portlet__head-text">Emitir noticia</h3>
        </div>
      </div>
    </div>
    <form class="m-form m-form--fit m-form--label-align-right" action="{{route('noticias.store')}}" enctype="multipart/form-data" method="post">
      {{ csrf_field() }}
      {{ method_field('POST') }}
      <div class="m-portlet__body">
        ...
        <div class="form-group m-form__group">
          ...
          <input class="form-control m-input" type="text" name="titulo_es" value="">
        ...
        <div class="form-group m-form__group">
          ...
          <input class="form-control m-input" type="text" name="titulo_en" value="">
        ...
        <div class="form-group m-form__group">
          ...
          <input class="form-control m-input" type="text" name="titulo_fr" value="">
          <span class="m-form__help">Escriba el titulo de tu noticia en Francés</span>
        </div>
        <div class="form-group m-form__group">
          <label for="es">Noticia en Español</label>
          <textarea class="form-control m-textarea" name="es" rows="8" cols="80"></textarea>
        ...
        <div class="form-group m-form__group">
          ...
          <textarea class="form-control m-textarea" name="fr" rows="8" cols="80"></textarea>
