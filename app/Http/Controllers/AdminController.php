...
class AdminController extends Controller
{
    ...
    {
        return view('pca.inicio');
    }
    public function cuenta()
    {
        return view('pca.cuenta');
    }
    public function tablaig()
    {
        return view('pca.ajustes.tabla');
    }
    public function camposig()
    {
        return view('pca.ajustes.campos');
    }
    public function tickets()
    {
        return view('pca.tickets.inicio');
    }
